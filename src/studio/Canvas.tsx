...
const INITIAL_HTML = `
  <!-- ANNOUNCEMENT BAR -->
  <div data-cuzmify-type="announcement" id="announcement" style="background:#083D50;color:#fff;padding:10px 24px;font-size:11px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:8px;font-family:monospace;">
